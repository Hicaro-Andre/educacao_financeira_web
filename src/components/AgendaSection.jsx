  ...
  return { isValid: true };
    ...
    if (name === "date") {
      ...
      if (selectedDate < today)
        return { isValid: false, error: "Selecione uma data a partir de hoje" };
      return { isValid: true };
    }
